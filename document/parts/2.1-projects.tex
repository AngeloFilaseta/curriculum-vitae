...
\cvitem{\cvdurationstyle{Novembre 2020}}{
	...
	\begin{itemize}[leftmargin=*]
		\item \textbf{Tecnologie utilizzate}: Gradle, Kotlin Multiplatform, GitHub Actions.
...
\cvitem{\cvdurationstyle{Novembre 2021 - Settembre 2022}}{
    ...
    \begin{itemize}[leftmargin=*]
		\item \textbf{Tecnologie utilizzate}: Java, C++, JaCaMo Framework, Node.js, Express, React.js. Redux, Mongoose,
		Gradle, PlatformIO, Docker, JSON-LD.
